...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Number of Generative AI Applications" src="https://img.shields.io/static/v1?label=Number%20of%20Generative%20AI%20Applications&message=3341&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>Gemma Guard — Android phishing detection with on-device Gemma 4</h4>
    <p>Gemma Guard is an Android app that captures the current screen, runs OCR, and uses Gemma 4 on-device to spot phishing before users tap. Private by design, explainable, and built for the Google Gemma 4 Good Hackathon.</p>
    <a href="https://thataicollection.com/redirect/gemma-guard" target="_blank"><b>Get Started with Gemma Guard</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>GitHub - kerbelp/metatron: Git-native context layer for AI coding agents. Your team's real engineering decisions — patterns, pitfalls, conventions — live as reviewed markdown files in your repo; agents consult them before writing code and record what they</h4>
    <p>Git-native context layer for AI coding agents. Your team's real engineering decisions — patterns, pitfalls, conventions — live as reviewed markdown files in your repo; agents consult them before writing code and record what they learn. Files-first, no server required; MCP as an optional serving layer. - kerbelp/metatron</p>
    <a href="https://thataicollection.com/redirect/metatron" target="_blank"><b>Get Started with Metatron</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>New exclusive porn image generation modes Glamour, Hardcore and POV!</h4>
    <p>aiAllure is an intelligent tool that lets users create personalized AI companions, often in the form of a virtual girlfriend. The platform is highly customizable, offering the freedom to choose the AIs look and  personality.

This creates a virtual romance experience unique to each user. Not only can pre-generated AI companions be interacted with, but users can also develop their own characters.</p>
    <a href="https://thataicollection.com/redirect/aiallure" target="_blank"><b>Get Started with aiAllure</b></a>
    <br />
</div>
...
- 🎼 [AI Song & Music Generator](#ai-song--music-generator)
- 🔮 [AI Tarot & Divination](#ai-tarot--divination)
- 📈 [Accounting & Finance](#accounting--finance)
- 🪧 [Ad Creative Generator](#ad-creative-generator)
- 🦾 [Agentic Coding](#agentic-coding)
- 🎲 [Animation & 3D Modeling](#animation--3d-modeling)
- 🏯 [Architecture & Interior Design](#architecture--interior-design)
- 🎧 [Audio Enhancer & Vocal Removal](#audio-enhancer--vocal-removal)
- 😎 [Avatars](#avatars)
- 🪄 [Background Remover](#background-remover)
- 📖 [Book & Novel Writer](#book--novel-writer)
...
- 🗄️ [Database & SQL Assistant](#database--sql-assistant)
- 💘 [Dating Profile & Pickup Line](#dating-profile--pickup-line)
- 🛒 [Ecommerce](#ecommerce)
- 📧 [Email Assistant](#email-assistant)
- ✉️ [Email Marketing](#email-marketing)
- 🎲 [Entertainment & Novelty](#entertainment--novelty)
- 📸 [Face & Beauty Rating](#face--beauty-rating)
- 👩‍🎤 [Fashion](#fashion)
- 🎮 [Gaming](#gaming)
- 🎁 [Gift Ideas & Recommendations](#gift-ideas--recommendations)
- 🪪 [Headshot Generator](#headshot-generator)
...
- 🎙️ [Interview Preparation](#interview-preparation)
- 🗣️ [Language Learning](#language-learning)
- 👩‍⚖️ [Legal](#legal)
- ⚜️ [Logo Generator](#logo-generator)
- 🍳 [Meal & Recipe Planner](#meal--recipe-planner)
- 👨‍💻 [Meeting Assistant](#meeting-assistant)
- 📱 [Mobile App Builder](#mobile-app-builder)
- 🏷️ [Name, Slogan & Naming Generator](#name,-slogan--naming-generator)
- 🧠 [Note Taking & Second Brain](#note-taking--second-brain)
- 📦 [Other](#other)
- 📄 [PDF & Document Tools](#pdf--document-tools)
- 🌱 [Personal Growth & Wellness](#personal-growth--wellness)
- 🖼️ [Photo Restoration](#photo-restoration)
- 🔌 [Plugins & Extensions](#plugins--extensions)
- 🎙️ [Podcast Tools](#podcast-tools)
- 💡 [Prompt Library & Engineering](#prompt-library--engineering)
- 🧑‍💼 [Recruiting & ATS](#recruiting--ats)
- 🎓 [Research Assistant](#research-assistant)
- 📋 [Resume & CV Builder](#resume--cv-builder)
- 🔍 [SEO & Keyword Research](#seo--keyword-research)
- 📞 [Sales Outreach & Lead Gen](#sales-outreach--lead-gen)
...
- ✅ [Task & Personal Assistant](#task--personal-assistant)
...
- 🛠️ [Vibe Coding & App Builder](#vibe-coding--app-builder)
- 🎤 [Video Dubbing & Translation](#video-dubbing--translation)
- 🎬 [Video Editing](#video-editing)
- ☎️ [Voice Agent & Phone Bot](#voice-agent--phone-bot)
...
#### The All in one AI Creative Platform for Creators, Marketers & Ecommerce


[Visit](https://thataicollection.com/redirect/anyvids?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Anyvids is an all‑in‑one AI video and image creation platform that brings every top model and a complete creative toolkit into one place for content creators, designers, and ecommerce teams, helping you go from product to published content fast.


[More Information and Pricing](https://thataicollection.com/en/application/anyvids?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### GPT Image 2.5 AI Image Generator | Sharp Detail, Exact Text
...
Create AI images with GPT Image 2.5: sharper high-res output, exact text, clean repeated edits, 16 reference images, text-to-image and image-to-image up to 4K.


[More Information and Pricing](https://thataicollection.com/en/application/gpt-image-2-5-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### FastSolve — The Invisible AI That Solves LMS Homework Fast


[Visit](https://thataicollection.com/redirect/fastsolve?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

AI Chrome extension that solves Canvas, Blackboard, Moodle & Brightspace LMS questions in 2 seconds — invisible on screenshare. Free to try, no card.


[More Information and Pricing](https://thataicollection.com/en/application/fastsolve?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 시댄스 2.5 무료 체험 | 씨댄스·Seedance 2.5 AI 영상 생성기


[Visit](https://thataicollection.com/redirect/시댄스-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

시댄스 2.5(씨댄스 2.5, Seedance 2.5)는 차세대 AI 영상 모델입니다. 가입 즉시 16크레딧 무료, 카드 등록 없이 프롬프트 하나로 네이티브 30초 4K 영상을 만들어 보세요. 최대 50개의 멀티모달 레퍼런스와 모든 프레임에서 일관된 캐릭터까지.


[More Information and Pricing](https://thataicollection.com/en/application/시댄스-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### GPT Image 2.5 — Free AI Image Generator & Editor
...
Create with GPT Image 2.5 - reasoning-first generation, 99% typography accuracy, reference-guided editing, and up to 8 consistent images per prompt. Free, up to 4K.


[More Information and Pricing](https://thataicollection.com/en/application/gpt-image-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI Email Writer — Write 87% Faster, Get More Replies | WriteMail.ai
...
320,000+ professionals write emails 87% faster. Free AI email writer — type your key points, get polished emails that get replies. No signup needed.


[More Information and Pricing](https://thataicollection.com/en/application/writemail-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Pixo - Your AI Film Crew


[Visit](https://thataicollection.com/redirect/pixo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

AI agents that research, script, and edit your videos. You direct — they deliver.


[More Information and Pricing](https://thataicollection.com/en/application/pixo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Launch hosted Hermes and OpenClaw agents with Platform Credits, provider API keys, or supported AI subscriptions. Manage Agent Teams, Starter Kits, Claw Earn tasks, and 1,300+ agent listings.
...
[See All 🦾 AI Agents Applications on AI Collection](https://thataicollection.com/en/categories/ai-agents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Paste content once, get the whole batch of on-brand visuals in your client's language: 150+ languages, 100+ formats, in about a minute. Start free.
...
Photo to Photo Style Transfer that mirrors any reference image onto your own photos in seconds—try it now.


[More Information and Pricing](https://thataicollection.com/en/application/picture-to-drawing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AnimeGenius is the #1 Anime AI Generator, accessible for free.
...
#### Humanize AI - Free Humanize AI Text Tool
...
Humanize AI is a free Humanize AI text tool that converts AI text into natural human like text
...
#### Best free AI Detection Remover and AI Rewriter.
...
#### AI Detector - Trusted AI Checker for ChatGPT, GPT5 & Gemini
...
BeatViz AI: The ultimate, all-in-one AI music and video generator. Turn your ideas into full tracks and professional-grade music videos instantly. Create high-quality, synchronized music and visuals from simple text prompts, no complex skills or expensive studio equipment needed.
...
Audialab offers innovative AI tools designed specifically for artists, enabling new creative possibilities.
...
[See All 🔮 AI Tarot & Divination Applications on AI Collection](https://thataicollection.com/en/categories/ai-tarot-and-divination?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fully managed NLP-as-a-Service delivered via API, at 30% the cost. Switch easily with feature parity to industry standards.
...
#### COO consultancy specializing in management systems and more.
...
StockGPT is an AI-powered search tool designed for financial research, providing knowledge of earnings releases and financial reports for S&P 500 and Nasdaq companies.
...
We combine top-tier M&A advisors with AI to deliver faster, higher-value outcomes for small and medium businesses.
...
#### MoneyCoach: Budget Planner App - App Store


[Visit](https://thataicollection.com/redirect/moneycoach?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Download MoneyCoach: Budget Planner by MoneyCoach UG on the App Store. See screenshots, ratings and reviews, user tips, and more apps like MoneyCoach: Budget…
...
Easily create, launch and optimize your ad campaigns across retail media networks. One place to help you reach your customers. Try free →
...
Create free 3D models with Tripo AI online — turn your text or images into high-fidelity 3D models instantly, ready for games, 3D printing and animation
...
#### Transform your ideas into 3D models effortlessly.


[Visit](https://thataicollection.com/redirect/make3d?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Make3D allows users to convert 2D images into stunning 3D models quickly and easily.
...
#### neural frames | AI Animation Generator | Create AI Videos | Neural Frames
...
neural frames is a stunning AI animation generator with precise frame-by-frame control. Our advanced video editor gives you complete creative freedom throughout the entire generation process. Upload your music to create dynamic, audio-reactive visuals that perfectly sync with your sound.
...
#### Onton — Stop scrolling, start shopping
...
Audio Enhancer offers powerful tools for cleaning and enhancing audio, ideal for content creators and professionals.
...
Train an AI model on your own photos and then generate realistic AI photos that look just like you or your loved ones.

Upgrade your dating app profile pictures, see what you would look like with your dream body, create professional profile photos for LinkedIn or CVs, see the baby you would have with your partner ... The possibilities are undless.
...
#### AI Story Generator — Create Stories with AI in Seconds
...
Generate unique stories instantly with our free AI story generator. Choose genre, length, and language, add AI pictures. No writing skills needed.
...
[See All 📇 CRM & Customer Data Applications on AI Collection](https://thataicollection.com/en/categories/crm-and-customer-data?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Automatically document your codebase, from legacy to modern.
...
[See All 💻 Coding Assistant Applications on AI Collection](https://thataicollection.com/en/categories/coding-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
One prompt to a live app - CRMs, dashboards, client portals run by AI agents and workflow automations. Build free with Taskade Genesis, no credit card.
...
Everneed AI is an all-in-one platform for entrepreneurs and marketers that can assist you with text generation, text-to-speech conversion, coding,  and much more.
...
Content Raptor tells you which pages to optimize next, based on your Google Search Console data, then tracks whether your changes actually moved rankings. $47/mo.
...
[See All 📝 Cover Letter Generator Applications on AI Collection](https://thataicollection.com/en/categories/cover-letter-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Build custom AI agents and chatbots for customer support. Deploy to websites, WhatsApp, Slack, and 10+ platforms. HIPAA compliant, with live chat escalation. BAA available for customers on the Standard plan or above.
...
Build an AI chatbot for your website in minutes. Train it on your data, deploy across WhatsApp, Instagram, Slack and more. Free plan available — no code needed. Trusted by brands worldwide.
...
[More Information and Pricing](https://thataicollection.com/en/application/llm-powered-invoice-and-receipt-extractor-oss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Custom Excel and Google Sheets reporting for multi-entity finance teams: every QuickBooks and Xero entity, one workbook, always current.
...
QueryGenie helps you construct SQL queries effortlessly with a user-friendly interface.
...
#### Convert natural language into SQL queries effortlessly.


[Visit](https://thataicollection.com/redirect/text2sql?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Text2SQL.AI enables users to transform natural language questions into SQL queries without any coding experience. It's designed for both developers and non-technical users alike.
...
IntelliMail is a Chrome extension that generates your emails, ensuring you never have to write one again.
...
[See All ✉️ Email Marketing Applications on AI Collection](https://thataicollection.com/en/categories/email-marketing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Create AI videos online with PopVid AI. Upload a photo, choose a template, or write a prompt to generate fun videos in seconds.
...
#### AI role-play chat and story generator.
...
Create your personalized deck of cards and play with your friends. Select which cards should be part of your own deck by swiping 💅.


[More Information and Pricing](https://thataicollection.com/en/application/langame-card-game?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Accurately rate and analyze your face with AI-powered insights.
...
#### AI-driven Tool for Engaging Content Creation.


[Visit](https://thataicollection.com/redirect/swagai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Swag AI empowers users to create engaging and customized content using AI technology. Ideal for marketers and content creators who want to enhance their workflow.
...
#### Where effortless virtual try-ons meet innovative AI outfit changing for every style and body type.
...
#### DUMDUM4D Link Slot Gacor Hari Ini | Jackpot Provider Slot Deposit QRIS
...
Mainkan link slot gacor hari ini di DUMDUM4D. Jackpot besar dari berbagai provider slot terpercaya, deposit cepat via QRIS. Update link gacor setiap hari!
...
#### Play chess against an AI powered by Betafish.js.


[Visit](https://thataicollection.com/redirect/chess-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Betafish.js allows users to play chess against an AI, providing various settings for thinking times.
...
Generate professional headshots instantly with Supawork’s free AI headshot generator. Choose from 30+ styles and create perfect photos for resumes, LinkedIn, portfolios, and team profiles.
...
#### Professional AI Headshots to Elevate Your Online Presence.
...
Professional AI Headshots to Elevate Your Online Presence. Virtually indistinguishable from real. Upgrade Your Business Photos
...
#### Transforming the way businesses harness AI.


[Visit](https://thataicollection.com/redirect/fulgent-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Fulgent AI provides advanced AI solutions to streamline business operations and enhance decision-making processes.
...
#### Empowering businesses to grow sustainably.


[Visit](https://thataicollection.com/redirect/getactyv?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Actyv offers innovative solutions for businesses looking to enhance growth and sustainability through data-driven decision making.
...
#### Assignment Helper #1 AI Writing Service | AssignmentGPT AI
...
Assignmentgpt AI is outstanding AI platform that give student to generate assignments. Students can also use for homework help and math problem solution as well.
...
Create your Statement of Purpose with SOP Creator, the best AI-powered SOP maker. Our online tool helps you effortlessly generate personalized SOPs for students across all academic levels—Bachelors, Masters, PhD, or MBA. Elevate your university application with a unique and powerful SOP.


[More Information and Pricing](https://thataicollection.com/en/application/sopcreator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 📚 Homework & Essay Helper Applications on AI Collection](https://thataicollection.com/en/categories/homework-and-essay-helper?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Free AI image editor online. Upload a photo, describe the edit in plain words, and AI does it in seconds. 100+ one-tap filters. Nothing to install.
...
Generate unique, lifelike images and videos for characters, products, and more with our user-friendly platform.
...
[More Information and Pricing](https://thataicollection.com/en/application/fotor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
WaifuXL allows users to choose and download images of popular anime characters known as 'waifus'.
...
AVCAI offers a comprehensive suite of AI-powered tools for enhancing photo quality through upscaling, noise reduction, background removal, and more. It provides free credits to try all features without needing a credit card.
...
EbSynth is VFX software for creative video transformations, retouching, and rotoscopy.
...
Deep Nostalgia AI is a instant-access model that animates your cherished old photos, turning them into lifelike videos. Experience the magic of AI and relive your precious memories effortlessly.
...
[See All 🎬 Image to Video Animation Applications on AI Collection](https://thataicollection.com/en/categories/image-to-video-animation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI Interview Copilot & Interview Prep
...
[More Information and Pricing](https://thataicollection.com/en/application/interviews-chat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### ParakeetAI - AI Interview Assistant Software
...
Real-time AI answers to interview questions with ChatGPT. AI interview assistant software. Interview Copilot.
...
#### MIND Interview | Enterprise AI Recruitment & Headhunting
...
Redefine hiring with ISO 42001 standards. Combine AI video interviews, resume analysis, and expert headhunting to accelerate your global recruitment process.
...
#### Lingostar AI | Practice Real Conversations to Learn Languages Fast - LingoStar AI


[Visit](https://thataicollection.com/redirect/lingostar?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Practice speaking English, Spanish, and French naturally with our advanced AI conversation partner. Build confidence, improve pronunciation, and achieve
...
#### Get quick answers to aviation regulations with AI.
...
MagiMaker provides tailored design solutions for book/podcast covers, logos, and more. 

Our user-friendly platform creates high quality results via a simple Q&A process - no learning curve required! 

We strive for expediency, providing your creative concepts, Midjourney prompts, and selected best images within 24 hours, along with any necessary adjustments such as text or element removal. 
...
[See All ⚜️ Logo Generator Applications on AI Collection](https://thataicollection.com/en/categories/logo-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
FoodAI leverages artificial intelligence to curate personalized meal recommendations and nutritional insights.
...
#### Discover the perfect name for your brand or project.
...
NameFinder helps you generate unique names for businesses, products, or projects using advanced algorithms that consider your input preferences.
...
#### Generate unique, brandable business names using AI.
...
[See All 🏷️ Name, Slogan & Naming Generator Applications on AI Collection](https://thataicollection.com/en/categories/name-slogan-and-naming-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Write, make, collaborate, and publish – with a personal AI that knows your projects, files, and ideas. For thinkers, researchers, designers, and teams.


[More Information and Pricing](https://thataicollection.com/en/application/fabric?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Generate UGC videos, AI influencers, and more with IndexApps. Perfect for social media marketing without needing filming or technical skills.
...
[See All 📦 Other Applications on AI Collection](https://thataicollection.com/en/categories/other?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Read, summarize and translate any PDF online with a free AI PDF reader. Upload a file, ask questions in any language, get answers in seconds — no sign-up.
...
Upload a PDF and get a summary in seconds!


[More Information and Pricing](https://thataicollection.com/en/application/pdf-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
RTutor turns your natural language questions into R or Python code for data analysis. Upload datasets and get results in seconds.
...
Human-led, AI-assisted creativity


[More Information and Pricing](https://thataicollection.com/en/application/daydrm?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Explore AI models, build perfect prompts, and master AI image generation.
...
#### Unlock AI with expertly crafted prompts.
...
Discover the art of prompt engineering with resources and guides tailored for AI enthusiasts and professionals.
...
Discover a universe of creativity with hand-picked, weekly updated resources, tutorials, and example prompts to create videos from text using Ope...
...
Discover a universe of creativity with hand-picked, weekly updated resources, tutorials, and example prompts to create videos from text using OpenAI''s Sora....


[More Information and Pricing](https://thataicollection.com/en/application/sora-prompts-today?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Discover the best AI jobs from top AI labs and companies. Browse by role, location, and remote — and get new roles in your inbox.
...
#### AI Recruiting Software for Healthcare & Insurance | HireQuotient
...
Job application AI for jobseekers. Get a job-specific cover letter, tailored resume and follow-up email instantly—then auto-apply faster with AIApply.
...
Stop paying to download your resume. Huntr's AI Resume Builder helps helps you create, tailor, and download unlimited, ATS-friendly resumes for free.
...
#### The #1 AI Resume Builder – Forbes' Top Pick. Trusted by 4.3M
...
Land More Interviews with the #1 AI Resume Builder. Rezi's AI builds ATS-proof resumes that actually get callbacks. 4M+ job seekers trust it, Forbes ranks it #1. Free, done in minutes.
...
#### BacklinkGPT – The AI Agent That Hunts Backlinks for You
...
Enter your domain. BacklinkGPT's AI agent scans the SERPs, judges every prospect, finds the right contact, and runs the outreach — on autopilot or with your approval.
...
Stop stitching together old SEO tools. Quattr’s AI‑native SEO suite helps research topics, drafts optimized content, auto‑links pages, and wins top rankings & AI citations on Google and ChatGPT.


[More Information and Pricing](https://thataicollection.com/en/application/quattr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Purchase the domain seoby.ai for $18,888.00 plus transfer fee.
...
[See All 🔍 SEO & Keyword Research Applications on AI Collection](https://thataicollection.com/en/categories/seo-and-keyword-research?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
ApplyPass is the best job search AI tool that auto-applies to 400+ software engineering jobs weekly, optimized for ATS and tailored for US & Canada roles.


[More Information and Pricing](https://thataicollection.com/en/application/applypass?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### LinkDR: Managed backlinks


[Visit](https://thataicollection.com/redirect/linkdr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Buy real publisher backlinks, priced by Domain Rating. Buy once or subscribe monthly from $160 a link. Links typically live in 3–4 weeks.
...
Reverse video search powered by AI. Upload a clip or paste a URL to find original video sources, detect duplicates, and verify authenticity across YouTube, TikTok, Instagram, and more.


[More Information and Pricing](https://thataicollection.com/en/application/frametrace-|-reverse-video-search?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Situs Deposit Pulsa Tri dan IM3 Tanpa Potongan 10k Only
...
#### AI Ad Generator - Make AI Ads & Ad Videos that Win | Predis.ai


[Visit](https://thataicollection.com/redirect/predis?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Create AI ads, video ads in seconds with our free AI ad generator. Use AI and turn text prompts into AI video ads.
...
CommentGuard is the #1 comment moderation software for Facebook & Instagram posts and ads. Free 7-day trial. No credit card required.
...
#### AI Music Video Generator - Make a Music Video from Any Song
...
Upload your song or MP3 and AI generates a beat-synced music video in minutes. Works for every genre, Suno tracks included. Start free, no editing experience...
...
HarmonySnippetsAI is a game-changer for finding the most captivating segments in your music tracks, especially if you're trying to optimize content for social media.

How it works:

Upload your track (MP3 or WAV), & the AI will analyze it to pick out the catchiest segments. No more guesswork.

If you've ever been unsure about which part of your track to feature, this tool is for you. 


[More Information and Pricing](https://thataicollection.com/en/application/harmonysnippetsai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### FUFUSLOT > Alternativ Situs Slot Online Terlengkap dan Reward Terbesar
...
FUFUSLOT memberikan kesempatan menikmati setiap sensasi maxwin, reward terbaik, serta kemudahan akses link alternativ masuk ke slot online.
...
Askbotta is a platform designed to help users formulate and ask questions effectively to receive optimal responses.
...
TodoBee helps you organize your tasks efficiently and boosts your productivity.
...
Jigso provides ChatGPT 4.0 integration in Slack, allowing users to interact with organizational apps, manage topics, and summarize conversations effortlessly.
...
#### Your AI-powered conversational agent.


[Visit](https://thataicollection.com/redirect/replai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Repl.ai offers an AI-driven solution to enhance customer engagement and automate conversations.
...
#### Transform any text into natural-sounding audio with advanced AI voice technology.
...
This is a domain details page indicating the need for JavaScript to function properly.
...
#### LTX - Create stunning videos in seconds with LTX


[Visit](https://thataicollection.com/redirect/ltx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

LTX-Video by Lightricks. First DiT-based real-time AI video generation model. Open-source, fast, professional quality for text-to-video and image-to-video.


[More Information and Pricing](https://thataicollection.com/en/application/ltx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Expert guides to beaches and coastal destinations. Find the best beach experience tailored for your travel needs.
...
#### Connecting communities through engaging activities.


[Visit](https://thataicollection.com/redirect/roamr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

LetsRoam is a platform designed to bring people together through fun and interactive activities catered to various interests and groups.
...
#### Revolutionizing the gaming and lottery experience.


[Visit](https://thataicollection.com/redirect/aspen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Discover intelligent automation solutions tailored for the gaming and lottery industry, enhancing user experience through data-driven insights.
...
AI Dev Codes uses OpenAI's ChatGPT model to generate custom web pages. It allows for image generation and includes a voice interface for enhanced interaction.
...
BuildAI is the easiest way to build professional AI apps, products, and online businesses without coding. Turn your ideas into fully functional apps instantly with AI.


[More Information and Pricing](https://thataicollection.com/en/application/buildai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎤 Video Dubbing & Translation Applications on AI Collection](https://thataicollection.com/en/categories/video-dubbing-and-translation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Upload two photos, and let our AI instantly generate natural, HD-quality kissing videos — secure, private, and fun.


[More Information and Pricing](https://thataicollection.com/en/application/free-ai-kissing-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AirOps | Growth platform for AI search & AEO


[Visit](https://thataicollection.com/redirect/airops?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

The AI search and AEO platform that ships the content that gets you cited and tracks your LLM visibility across ChatGPT, Perplexity, Gemini, and Google.
...
[More Information and Pricing](https://thataicollection.com/en/application/wordfixerbot?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Free AI text summarizer for long text, articles and PDFs. Choose bullet points or a paragraph, set the length, and get the key points in seconds — no sign-up, no word cap at 600, plus a chat to ask follow-up questions.
...
#### The all-in-one AI creation platform for creators and marketers.


[Visit](https://thataicollection.com/redirect/chatart?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

ChatArt is an all-in-one AI creation platform for creators and marketers. Generate videos, images, music, copy, and more in one workspace.
...
Compare Smodin pricing plans and choose the right AI writing and plagiarism checking tools for your needs.
...
#### Best AI Business Plan Generator & Writer | BizPlanner AI
...
AI business plan generator. Create investor-ready plans with financials, market analysis, and SWOT in minutes. 27,300+ plans created.
