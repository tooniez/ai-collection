...
<a target="_blank" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fgithub.com%2Fai-collection%2Fai-collection%2Fblob%2Fmain%2FREADME.fr.md&text=D%C3%A9couvrez%20cette%20collection%20AI%20d'applications%20AI%20g%C3%A9n%C3%A9ratives%20impressionnantes!%20%40ai_collection_&hashtags=aicollection"><img alt="Twitter URL" src="https://img.shields.io/twitter/url?label=Partager&style=social&url=https%3A%2F%2Ftwitter.com"></a> <a class="twitter-follow-button" href="https://twitter.com/ai_collection_" data-size="large"><img alt="Twitter Follow" src="https://img.shields.io/twitter/follow/ai_collection_?style=social"></a>
...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Nombre d'applications d'IA générative" src="https://img.shields.io/static/v1?label=Nombre%20d'applications%20d'IA%20g%C3%A9n%C3%A9rative&message=3355&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<a href="https://github.com/ai-collection/ai-collection/stargazers"><img alt="GitHub stars" src="https://img.shields.io/static/v1?label=stars&message=9141&color=blue&style=flat-square&logo=github&logoColor=white" /></a> &nbsp;
<a href="https://github.com/ai-collection/ai-collection/network/members"><img alt="GitHub forks" src="https://img.shields.io/static/v1?label=forks&message=1016&color=blue&style=flat-square&logo=github&logoColor=white" /></a> &nbsp;
<a href="https://github.com/ai-collection/ai-collection/commits/main"><img alt="Last commit" src="https://img.shields.io/static/v1?label=last%20commit&message=2026-09-08&color=informational&style=flat-square" /></a> &nbsp;
...
<div align="center">
    <a href="https://thataicollection.com/redirect/gemma-guard" target="_blank" style="outline:none;border:none;">
        <img width="400" src="https://aicollection.s3.amazonaws.com/screenshots/screenshot-gemma-guard.webp" alt="Gemma Guard" border="0"/>
    </a>
    <h4>Gemma Guard — Détection du phishing sur Android grâce à Gemma 4</h4>
    <p>Application Android qui capture l'écran, exécute l'OCR et utilise Gemma 4 en local pour détecter et expliquer les risques de phishing avant que les utilisateurs n'appuient.

Gemma Guard a été créée pour le Google Gemma 4 Good Hackathon en tant qu'application Android axée sur la confidentialité qui montre comment utiliser Gemma dans un véritable flux de travail de sécurité mobile : capture un écran risqué, raisonne localement, explique le résultat et aide l'utilisateur à agir en toute sécurité.</p>
    <a href="https://thataicollection.com/redirect/gemma-guard" target="_blank"><b>Démarrer avec Gemma Guard</b></a>
    <br />
</div>
...
<div align="center">
    <a href="https://thataicollection.com/redirect/metatron" target="_blank" style="outline:none;border:none;">
        <img width="400" src="https://aicollection.s3.amazonaws.com/screenshots/screenshot-metatron.webp" alt="Metatron" border="0"/>
    </a>
    <h4>null</h4>
    <p>null</p>
    <a href="https://thataicollection.com/redirect/metatron" target="_blank"><b>Démarrer avec Metatron</b></a>
    <br />
</div>
...
<div align="center">
    <a href="https://thataicollection.com/redirect/memegenai" target="_blank" style="outline:none;border:none;">
        <img width="400" src="https://aicollection.s3.amazonaws.com/screenshots/screenshot-memegenai.webp" alt="MemeGenAI" border="0"/>
    </a>
    <h4>Cet outil d'IA totalement gratuit aide les utilisateurs à générer des mèmes GIF personnalisés. Ils peuvent partager leur travail avec leurs amis et leur famille, et le destinataire peut interagir avec ce mème pour créer un nouveau mème remix. </h4>
    <p>Cet outil d'IA totalement gratuit aide les utilisateurs à générer des mèmes GIF qui transmettent des émotions et des mouvements plus complexes que les mèmes statiques traditionnels. Ils peuvent partager leur travail avec leurs amis et leur famille, et le destinataire peut réagir et interagir avec ce mème sur notre site web en choisissant d'envoyer un message plus lent ou de le gifler, etc., ce qui contribuera à créer un nouveau mème itératif et interactif. </p>
    <a href="https://thataicollection.com/redirect/memegenai" target="_blank"><b>Démarrer avec MemeGenAI</b></a>
    <br />
</div>
...
- 🦾 [Agents d'IA](#agents-d'ia)
- 🌄 [Art et illustration basés sur l'IA](#art-et-illustration-basés-sur-l'ia)
- 🕵️ [Détecteur et humaniseur d'IA](#détecteur-et-humaniseur-d'ia)
- 🎼 [Générateur de chansons et de musique IA](#générateur-de-chansons-et-de-musique-ia)
- 🔮 [Tarot et divination par IA](#tarot-et-divination-par-ia)
- 📈 [Comptabilité et Finance](#comptabilité-et-finance)
- 🪧 [Générateur de publicités](#générateur-de-publicités)
- 🦾 [Codage agentic](#codage-agentic)
- 🎲 [Animation & Modélisation 3D](#animation--modélisation-3d)
- 🏯 [Architecture & Design d''intérieur](#architecture--design-d''intérieur)
- 🎧 [Améliorateur audio et suppression de la voix](#améliorateur-audio-et-suppression-de-la-voix)
- 😎 [Avatars](#avatars)
- 🪄 [Suppresseur d'arrière-plan](#suppresseur-d'arrière-plan)
- 📖 [Auteur de livres et de romans](#auteur-de-livres-et-de-romans)
- 📇 [CRM et données clients](#crm-et-données-clients)
- 🤖💬 [Chatbot](#chatbot)
- 💻 [Assistant de codage](#assistant-de-codage)
- 📠 [Génération de contenu et référencement](#génération-de-contenu-et-référencement)
- 📝 [Générateur de lettres de motivation](#générateur-de-lettres-de-motivation)
- 👨‍💻 [Service client](#service-client)
- 📊 [Analyse des données](#analyse-des-données)
- 🗄️ [Assistant à la base de données et au SQL](#assistant-à-la-base-de-données-et-au-sql)
- 💘 [Profil de rencontre et ligne de retrait](#profil-de-rencontre-et-ligne-de-retrait)
- 🛒 [Commerce électronique](#commerce-électronique)
- 📧 [Assistant de messagerie](#assistant-de-messagerie)
- ✉️ [Marketing par e-mail](#marketing-par-e-mail)
- 🎲 [Divertissement et nouveautés](#divertissement-et-nouveautés)
- 📸 [Évaluation du visage et de la beauté](#évaluation-du-visage-et-de-la-beauté)
- 👩‍🎤 [Mode](#mode)
- 🎮 [Jeux](#jeux)
- 🎁 [Idées cadeaux et recommandations](#idées-cadeaux-et-recommandations)
- 🪪 [Générateur de headshots](#générateur-de-headshots)
- 👩‍⚕️ [Soins de santé](#soins-de-santé)
- 📚 [Aide aux devoirs et à la rédaction](#aide-aux-devoirs-et-à-la-rédaction)
- 🖼️ [Retouche d'images](#retouche-d'images)
- 🔬 [Image Upscaler](#image-upscaler)
- 🔁 [Variation d'une image à l'autre](#variation-d'une-image-à-l'autre)
- 🎬 [Animation image-vidéo](#animation-image-vidéo)
- 🎙️ [Préparation à l'entretien](#préparation-à-l'entretien)
- 🗣️ [Apprentissage des langues](#apprentissage-des-langues)
- 👩‍⚖️ [Juridique](#juridique)
- ⚜️ [Générateur de logos](#générateur-de-logos)
- 🍳 [Planificateur de repas et de recettes](#planificateur-de-repas-et-de-recettes)
- 👨‍💻 [Assistante de réunion](#assistante-de-réunion)
- 📱 [Créateur d'applications mobiles](#créateur-d'applications-mobiles)
- 🏷️ [Générateur de noms, de slogans et de noms](#générateur-de-noms,-de-slogans-et-de-noms)
- 🧠 [Prise de notes et deuxième cerveau](#prise-de-notes-et-deuxième-cerveau)
- 📦 [Autres](#autres)
- 📄 [Outils pour les PDF et les documents](#outils-pour-les-pdf-et-les-documents)
- 🌱 [Croissance personnelle et bien-être](#croissance-personnelle-et-bien-être)
- 🖼️ [Restauration de photos](#restauration-de-photos)
- 🔌 [Plugins et extensions](#plugins-et-extensions)
- 🎙️ [Outils de podcast](#outils-de-podcast)
- 💡 [Bibliothèque et ingénierie rapides](#bibliothèque-et-ingénierie-rapides)
- 🧑‍💼 [Recrutement et ATS](#recrutement-et-ats)
- 🎓 [Assistant de recherche](#assistant-de-recherche)
- 📋 [Créateur de CV et de CV](#créateur-de-cv-et-de-cv)
- 🔍 [SEO et recherche de mots clés](#seo-et-recherche-de-mots-clés)
- 📞 [Sensibilisation des ventes et génération de prospects](#sensibilisation-des-ventes-et-génération-de-prospects)
- 🔍 [Moteurs de recherche](#moteurs-de-recherche)
- 📊 [Diapositives et présentations](#diapositives-et-présentations)
- 📣 [Contenu sur les réseaux sociaux](#contenu-sur-les-réseaux-sociaux)
- 💞 [Réseaux Sociaux & Rencontres](#réseaux-sociaux--rencontres)
- 🔊 [Générateur d'effets sonores](#générateur-d'effets-sonores)
- 🎓 [Étude et tutorat](#étude-et-tutorat)
- ✅ [Assistante personnelle et chargée de tâches](#assistante-personnelle-et-chargée-de-tâches)
- 📝 [Génération de texte](#génération-de-texte)
- 📝🔉 [Texte pour parler](#texte-pour-parler)
- 🖌️ [Du texte à l'image](#du-texte-à-l'image)
- 🎞️ [Texte vers vidéo](#texte-vers-vidéo)
- 📲 [Créateur de TikTok et de shorts](#créateur-de-tiktok-et-de-shorts)
...
- 🛠️ [Codage Vibe et créateur d'applications](#codage-vibe-et-créateur-d'applications)
- 🎤 [Doublage et traduction de vidéos](#doublage-et-traduction-de-vidéos)
- 🎬 [Montage vidéo](#montage-vidéo)
- ☎️ [Agent vocal et robot téléphonique](#agent-vocal-et-robot-téléphonique)
...
### APIQIK
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-apiqik.webp" alt="APIQIK">

#### APIQIK est une plateforme API unifiée qui donne accès aux principaux modèles de LLM, d'image, de vidéo et de musique, avec des économies allant jusqu'à 70 %.


[Visit](https://thataicollection.com/redirect/apiqik?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

APIQIK fournit une API unifiée qui connecte les développeurs et les entreprises aux principaux modèles linguistiques, modèles de vision et services d'IA générative de premier plan. En éliminant la complexité liée à la gestion de plusieurs fournisseurs d'IA, notre plateforme rationalise l'intégration, réduit les frais de développement et aide les équipes à créer et à faire évoluer des applications basées sur l'IA de manière plus efficace et rentable.


[More Information and Pricing](https://thataicollection.com/fr/application/apiqik?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### SpeedPainter AI
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-speedpainter-ai.webp" alt="SpeedPainter AI">

#### Générateur AI Speedpaint : de la photo à une vidéo dessinée à la main en ligne


[Visit](https://thataicollection.com/redirect/speedpainter-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Convertit n'importe quelle photo en MP4 dessiné à la main avec des effets de dessin et des styles personnalisables pour les courtes vidéos sur les réseaux sociaux.


[More Information and Pricing](https://thataicollection.com/fr/application/speedpainter-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### Loci
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-loci.webp" alt="Loci">

#### Une IA entièrement privée et intégrée à l'appareil, aussi facile à gérer que ChatGPT


[Visit](https://thataicollection.com/redirect/loci?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Loci te permet de gérer les meilleurs modèles pour ton appareil, entièrement sur l'appareil, ce qui signifie que tes discussions restent totalement privées, qu'il fonctionne hors ligne (idéal pour les voyages et les urgences !) , est plus durable et, mieux encore, GRATUIT et illimité. Associe ton application mobile à ton ordinateur de bureau pour exécuter des modèles encore plus puissants de manière fluide. 


[More Information and Pricing](https://thataicollection.com/fr/application/loci?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### RoboRP
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-roborp.webp" alt="RoboRP">

#### RoborP — Chat RP par IA avec des personnages personnalisés


[Visit](https://thataicollection.com/redirect/roborp?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Découvrez un jeu de rôle IA illimité avec RoboRP. Crée ton propre chatbot, crée des stories et profite d'un chat RP IA réaliste à tout moment.


[More Information and Pricing](https://thataicollection.com/fr/application/roborp?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### Anyvids
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-anyvids.webp" alt="Anyvids">

#### La plateforme créative tout-en-un basée sur l'IA pour les créateurs, les spécialistes du marketing et le commerce électronique


[Visit](https://thataicollection.com/redirect/anyvids?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Anyvids est une plateforme tout-en-un de création de vidéos et d'images basée sur l'IA qui regroupe tous les meilleurs modèles et une boîte à outils créative complète pour les créateurs de contenu, les designers et les équipes de commerce électronique, afin de t'aider à passer rapidement du produit au contenu publié.


[More Information and Pricing](https://thataicollection.com/fr/application/anyvids?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### GPT Image 2.5 AI
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-gpt-image-2-5.webp" alt="GPT Image 2.5 AI">

#### GPT Image 2.5 — Générateur d'images IA avec des détails plus nets et un texte exact


[Visit](https://thataicollection.com/redirect/gpt-image-2-5-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Le générateur d'images basé sur l'IA basé sur le Web permet de convertir du texte en image et de l'image en 4K, prend en charge 16 images de référence et offre une meilleure précision rapide.


[More Information and Pricing](https://thataicollection.com/fr/application/gpt-image-2-5-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


### FastSolve
<img align="left" width="240" src="https://cdn.thataicollection.com/screenshots/screenshot-fastsolve.webp" alt="FastSolve">

#### Réponses et explications aux devoirs grâce à l'IA sur ta plateforme d'apprentissage


[Visit](https://thataicollection.com/redirect/fastsolve?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

FastSolve est une extension Chrome destinée aux étudiants qui fournit des réponses et des explications basées sur l'IA directement dans Canvas, Blackboard, Moodle et ALEKS. Double-cliquez sur une question pour obtenir de l'aide concernant les questions à choix multiples, les questions à compléter, les questions correspondantes ou les questions écrites. Un niveau gratuit inclut 10 questions à choix multiples par jour, avec des forfaits payants en option.


[More Information and Pricing](https://thataicollection.com/fr/application/fastsolve?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI Agent Store est l'endroit où les entreprises trouvent des agents d'IA qui fonctionnent et où les développeurs présentent leurs solutions. Parcourez notre répertoire d'agents intelligents vérifiés, trouve ceux qui correspondent à tes besoins ou répertorie tes propres créations pour toucher de nouveaux utilisateurs.


[More Information and Pricing](https://thataicollection.com/fr/application/ai-agent-store?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
BrainSoup est un client natif multi-agents et multi-LLM qui permet aux utilisateurs de créer une équipe d'agents d'IA personnalisés capables d'apprendre, de mémoriser, de réagir aux événements, d'utiliser des outils, de tirer parti de ressources locales et externes et de travailler ensemble pour résoudre des tâches de manière autonome.
...
Immersim AI est une plateforme de jeu de rôle immersive et narrative qui permet de créer une infinité d'univers interactifs, d'histoires, de scénarios et de personnages. 
Caractéristiques :
Création basée sur l'IA : transpose tes idées en toute fluidité en expériences immersives et interactives.
Des mondes sans limites : crée une infinité de scénarios et de personnages pour une exploration illimitée.


[More Information and Pricing](https://thataicollection.com/fr/application/immersimai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🦾 Agents d'IA Applications on AI Collection](https://thataicollection.com/fr/categories/ai-agents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/picture-to-drawing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Picture to Drawing est une plateforme avancée basée sur l'IA qui transforme des photos ordinaires en de superbes dessins artistiques en quelques secondes. Notre technologie d'intelligence artificielle de pointe analyse chaque détail de ta photo pour créer des conversions authentiques de l'image en dessin qui préservent l'essence et l'émotion de ton image d'origine.


[More Information and Pricing](https://thataicollection.com/fr/application/picture-to-drawing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
APOB AI fournit des services d'imagerie, de vidéo et de génération de portraits basés sur l'IA. Essaie gratuitement notre générateur de portraits IA APOB AI ! APOB permet aux utilisateurs de créer leur modèle d'IA exclusif pour générer des images de scène et des vidéos uniques avec différentes options de style. Le service est garanti par une génération rapide en quelques secondes, des caractères cohérents, des résultats de haute qualité et des possibilités illimitées. 
...
WriteHuman : humanise le texte de l''IA pour en faire une IA indétectable. Contournez la détection de l''IA avec le meilleur outil de suppression de détection d''IA au monde et AI Humanizer. Fonctionne avec GPTZero, Turnitin, Originality AI, etc.



[More Information and Pricing](https://thataicollection.com/fr/application/writehuman?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🕵️ Détecteur et humaniseur d'IA Applications on AI Collection](https://thataicollection.com/fr/categories/ai-detector-and-humanizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/beatviz-ai-music-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

BeatViz AI : L'ultime générateur de musique et de vidéos tout-en-un basé sur l'IA. Transforme instantanément tes idées en morceaux complets et en clips vidéo de qualité professionnelle. Créez de la musique et des visuels synchronisés de haute qualité à partir de simples instructions textuelles, sans compétences complexes ni équipement de studio coûteux.
...
Utilisez notre plugin révolutionnaire pour générer des échantillons de batterie sans fin, tous libres de droits


[More Information and Pricing](https://thataicollection.com/fr/application/emergent-drums?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Un assistant créatif pour les créatifs
Que vous soyez un développeur de jeux indépendant, un novice complet en musique ou un compositeur professionnel chevronné, AIVA vous accompagne dans votre processus créatif. Créez des thèmes convaincants pour vos projets plus rapidement que jamais, en tirant parti de la puissance de la musique générée par l''IA.
...
Audjust AI t'aide à modifier des fichiers audio existants et à créer de la musique à partir de textes ou de paroles. Notre éditeur audio raccourcit les chansons, allonge le son et trouve les boucles parfaites. La technologie intelligente permet de conserver les terminaisons naturelles. Pas de coupures ou de fondus maladroits. Notre générateur de musique basé sur l'IA transforme tes idées en morceaux professionnels en quelques secondes. Gratuit pour les créateurs et les musiciens.


[More Information and Pricing](https://thataicollection.com/fr/application/audjust-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Notre algorithme d'IA unique associe parfaitement l'ancienne sagesse du tarot à l'art moderne pour générer des images de cartes de tarot uniques rien que pour toi.


[More Information and Pricing](https://thataicollection.com/fr/application/tarot-card-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Découvrez l'art ancien de la cartomancie de Lenormand sur notre plateforme de lecture en ligne gratuite. Notre site web propose des lectures de cartes Lenormand intuitives et alimentées par l'IA pour t'aider à mieux comprendre ton passé, ton présent et ton futur. A le choix entre plusieurs tableaux, dont le classique Past-Present-Future, The Cross, 9 cartes et le Grand Tableau complet.
...
TaroTeller a pour objectif de proposer des lectures de tarots gratuites grâce à notre outil d'intelligence artificielle. Que tu cherches des conseils, des réponses ou que tu sois simplement curieuse de l'avenir, nos cartes de tarot alimentées par l'IA fournissent des informations précises et approfondies. Explorez l'inconnu et entreprenez un voyage de l'âme dès maintenant


[More Information and Pricing](https://thataicollection.com/fr/application/taroteller?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/rmiq-ads?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Le RMIQ te connecte à un espace publicitaire premium sur les principaux réseaux de médias de détail, par exemple Walmart Connect, Instacart, Amazon, Target et bien d'autres encore, vous permettant de contacter facilement tes clients, où qu'ils fassent leurs achats. Le RMIQ permet une optimisation automatique des publicités grâce à l'IA afin de maximiser le ROAS et de fournir des informations en temps réel ainsi que des reportages sur différents réseaux de médias de détail. 
...
Jot génère automatiquement des variations infinies de copie publicitaire pour vous à l''aide de l''IA. Rationalisez les processus de rédaction de votre équipe grâce à l''intelligence artificielle. Propulsé par OpenAI GPT-3.
...
[More Information and Pricing](https://thataicollection.com/fr/application/creatify-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
TestSprite est un agent de test d'IA totalement autonome qui gère l'ensemble du processus de test, de la génération de cas de test à la rédaction du code de test, en passant par le diagnostic des problèmes et même la proposition de correctifs. Avec TestSprite, notre objectif était de rendre les tests totalement indépendants pour les développeurs, afin qu'ils puissent se concentrer sur la création de produits incroyables.


[More Information and Pricing](https://thataicollection.com/fr/application/testsprite?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Génère instantanément des panneaux d'administration complets, des API et une interface utilisateur à partir du schéma de ta base de données, grâce à des agents d'IA et à des LLM, et espère avoir un environnement d'exécution évolutif automatique à l'avenir en fonction de l'utilisation, des temps d'exécution auto-évolutifs/revolve
...
Neural Frames : générateur d''animation basé sur l''IA qui permet de créer rapidement des vidéos trippantes, grâce à une automatisation des images image par image. Idéal pour les clips musicaux, les œuvres d''art numérique ou les animations basées sur l''IA.



[More Information and Pricing](https://thataicollection.com/fr/application/neuralframes?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Améliore la qualité audio et supprime les bruits de fond grâce à notre outil IA Background Noise Remover. Télécharge ton fichier audio et laisse la magie opérer.


[More Information and Pricing](https://thataicollection.com/fr/application/noise-remover?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Convertissez automatiquement les fichiers audio et vidéo et les flux audio en direct en texte avec les API Speech-to-Text d''AssemblyAI. Faites-en plus avec Audio Intelligence - résumé, modération de contenu, détection de sujet
...
Entraîne un modèle d'IA à partir de tes propres photos, puis génère des photos d'IA réalistes qui ressemblent à toi ou à tes proches.

Améliore les photos de profil de ton application de rencontres, vois à quoi tu ressemblerais avec le corps de tes rêves, crée des photos de profil professionnelles pour LinkedIn ou des CV, vois le bébé que tu aimerais avoir avec ton partenaire... Les possibilités sont infinies.


[More Information and Pricing](https://thataicollection.com/fr/application/real-photo-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/customqr-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Ajoute la photo d''un produit et Mokker AI remplacera l''arrière-plan comme par magie et de façon réaliste. Fini le look de Photoshop. Essaye-le gratuitement.
...
[More Information and Pricing](https://thataicollection.com/fr/application/scene-one?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Skydis est une puissante plateforme de chatbot basée sur l'IA conçue pour aider les entreprises à attirer les visiteurs de leur site Web et à capter de précieux prospects sans effort. Grâce à une interface simple par glisser-déposer, il permet à chacun de créer des chatbots personnalisés sans coder. La plateforme fonctionne 24 heures sur 24, 7 jours sur 7, et fournit des réponses intelligentes et précises basées sur les données de ton entreprise. Skydis s'intègre également parfaitement à des outils tels que


[More Information and Pricing](https://thataicollection.com/fr/application/skydis?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/codewp?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
BurstyAI est une plateforme qui propose des outils de flux de travail basés sur l'IA sans code pour automatiser et optimiser la création de contenu, le référencement (recherche de mots clés, création de backlinks), la diffusion par e-mail et l'engagement des influenceurs et partenaires.

Démarre rapidement avec plus de 30 modèles prêts à l'emploi pour la rédaction d'articles, la recherche de mots clés, la création de backlinks, la recherche de prospects, etc. Personnalise-les en fonction des besoins de ton 


[More Information and Pricing](https://thataicollection.com/fr/application/burstyai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
L''outil ultime pour rédiger la lettre de motivation parfaite


[More Information and Pricing](https://thataicollection.com/fr/application/cover-letter-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


[See All 📝 Générateur de lettres de motivation Applications on AI Collection](https://thataicollection.com/fr/categories/cover-letter-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/llm-powered-invoice-and-receipt-extractor-oss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/llm-powered-invoice-and-receipt-extractor-oss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Summereyes - Résume n''importe quel texte publié sur Internet en un clic. Va droit au but. Rapide. Boostez ta productivité grâce à un outil intégré et automatisé qui te permet de traiter bien plus d''informations, bien plus rapidement. Qu''il s''agisse d''articles ou d''e-mails, parcourez la BS et trouvez ce qui compte.
...
[More Information and Pricing](https://thataicollection.com/fr/application/genius-sheets?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 📊 Analyse des données Applications on AI Collection](https://thataicollection.com/fr/categories/data-analysis?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🗄️ Assistant à la base de données et au SQL Applications on AI Collection](https://thataicollection.com/fr/categories/database-and-sql-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Dating Photo AI est un service piloté par l'IA qui génère des photos de profil de rencontres de haute qualité à partir d'un petit ensemble d'images téléchargées. À l'aide d'une intelligence artificielle avancée, nous créons différentes photos pour améliorer ton profil de rencontre en ligne. Notre service est rentable, rapide et vise à augmenter à la fois la quantité et la qualité de tes matchs.


[More Information and Pricing](https://thataicollection.com/fr/application/dating-photo-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/rapidreply?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Mailsplash est ton outil de marketing par e-mail basé sur l'IA. De la rédaction à la personnalisation fluide du design, Mailsplash te fournit les outils dont tu as besoin pour révolutionner ta stratégie de marketing par e-mail.

Une fois que tu auras fini de concevoir tes e-mails, tu pourras les envoyer rapidement grâce à l'une de nos intégrations ESP personnalisées.


[More Information and Pricing](https://thataicollection.com/fr/application/mailsplash-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Outil puissant et simplifié pour envoyer des e-mails, créer des pages et automatiser votre marketing.


[More Information and Pricing](https://thataicollection.com/fr/application/getresponse?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎲 Divertissement et nouveautés Applications on AI Collection](https://thataicollection.com/fr/categories/entertainment-and-novelty?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Tu pourras découvrir ton archétype de beauté et t'appuyer pour mettre en valeur ta beauté naturelle. Nous partagerons des conseils personnalisés, avec des conseils détaillés pour t'aider à avoir la confiance et l'estime de soi que tu mérites !
...
ColorBliss te permet de créer toutes les pages à colorier que tu peux imaginer, exactement comme tu le souhaites.

Grâce à notre fonction d'invite de texte, tape simplement quelques mots pour décrire ton idée, et en moins de 5 secondes, tu auras une page à colorier unique. Associe les personnages, les décors et les styles pour donner vie à ton imagination !
...
[More Information and Pricing](https://thataicollection.com/fr/application/colorbliss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎁 Idées cadeaux et recommandations Applications on AI Collection](https://thataicollection.com/fr/categories/gift-ideas-and-recommendations?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI Matching : rencontre des experts en alimentation, en nutrition, en compléments alimentaires, en beauté, en fitness, en pleine conscience et plus encore pour un coaching et un soutien en matière de santé virtuels personnalisés



[More Information and Pricing](https://thataicollection.com/fr/application/well-me-right?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Oubliez les routines génériques et libérez tout votre potentiel de forme physique avec le plan d'entraînement à la callisthénie ! Notre offre gratuite propose une bibliothèque d'exercices efficaces de musculation, tandis que la version premium te permet d'utiliser nos algorithmes dynamiques pilotés par l'IA. Créez des plans personnalisés en quelques secondes en fonction de tes objectifs, de ton niveau d'expérience, de tes domaines cibles, etc.]


[More Information and Pricing](https://thataicollection.com/fr/application/calisthenics-workout-plan?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Rédigez des devoirs, des essais, des blogs et des plans de cours exceptionnels
...
AssignmentGPT AI - Fonctionnalités de l''assistant d''écriture

Libérez la puissance de l’IA pour obtenir des réponses précises à vos questions. Idéal pour les étudiants, les professionnels et toute personne ayant besoin d’informations rapides et fiables.

Coincé sur une mission difficile ? Obtenez des solutions étape par étape sur divers sujets. Rendre les devoirs moins stressants et plus éducatifs.
...
[See All 📚 Aide aux devoirs et à la rédaction Applications on AI Collection](https://thataicollection.com/fr/categories/homework-and-essay-helper?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
PicTools AI propose de puissants outils d'intelligence artificielle pour créer des images époustouflantes, supprimer des arrière-plans, flouter les photos, etc. Rapide, facile et conçu pour laisser libre cours à ta créativité !


[More Information and Pricing](https://thataicollection.com/fr/application/pictools-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Génère des photos de toi ou de tes amis et de ta famille :
- des photos professionnelles pour LinkedIn et des CV
- de superbes photos de profil pour Instagram ou Twitter
- de jolies photos de tes enfants ou de tes animaux de compagnie
- transformation corporelle (ajouter des muscles supplémentaires, perdre du poids,...)
- des photos sexy pour des applications de rencontres
-...


[More Information and Pricing](https://thataicollection.com/fr/application/ai-photos-editor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🖼️ Retouche d'images Applications on AI Collection](https://thataicollection.com/fr/categories/image-editing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Solution d''IA en un clic pour rendre vos photos plus nettes, plus nettes et plus propres. Augmentez la résolution de l''image sans perte de qualité. Qualité et résultat époustouflants. Agrandissez n''importe quelle petite image en 2k et 4k sans perte de qualité. Affinez les détails pour améliorer le visuel de l''image pour le partage et l''impression. L''amélioration des photos rendue facile pour tout le monde !


[More Information and Pricing](https://thataicollection.com/fr/application/ai-image-enlarger?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🔁 Variation d'une image à l'autre Applications on AI Collection](https://thataicollection.com/fr/categories/image-to-image-variation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Animez des photos, des images et des images en ligne avec AnimateMyPic. Pas de filigrane. Des mouvements réalistes. Créez des animations photo en quelques minutes.
...
Convertit des photos ou des textes en vidéos de baisers réalistes et en GIF. L'application Web exporte des fichiers MP4/GIF ; utilisation gratuite avec des crédits payants optionnels.
...
[More Information and Pricing](https://thataicollection.com/fr/application/ebsynth?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://www.interviews.chat)

Interviews Chat propose les outils d'IA les plus avancés pour t'aider à réussir tes entretiens d'embauche. Grâce à notre IA Interview Copilot, obtiens des retranscriptions en direct et des réponses en temps réel sur des plateformes telles que Zoom, Google Meet ou Teams. Prépare-toi aux entretiens d'embauche plus intelligemment grâce à AI Interview Prep. Analyse ton CV et ta description de poste pour générer des questions personnalisées pour la pratique.


[More Information and Pricing](https://thataicollection.com/fr/application/interviews-chat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Mind-interview est une plateforme de coaching d'entretien alimentée par l'IA, conçue pour aider les utilisateurs à se préparer aux entretiens d'embauche. Il propose des simulations d'entretiens personnalisées, des commentaires en temps réel et des suggestions personnalisées pour améliorer les compétences en matière d'entretien. La plateforme analyse les traits de personnalité, fournit des conseils pour se présenter et propose des conseils pour répondre aux questions d'entretien courantes et difficiles.



[More Information and Pricing](https://thataicollection.com/fr/application/mind-interview-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Speech Analyzer est un coach de maîtrise de l''anglais conversationnel alimenté par l''IA qui écoute votre discours et vous fournit un retour immédiat.


[More Information and Pricing](https://thataicollection.com/fr/application/elsa-speech-analyzer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/lorro?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/speakingclubai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Spellbook utilise GPT-3 pour réviser et suggérer la langue de vos contrats, directement dans Microsoft Word.
...
La création d'une marque commence ici !
Avec des centaines de modèles disponibles grâce à notre générateur de logos basé sur l'IA, tu peux lancer, développer et développer ton activité en toute confiance ! Et il n'y a pas besoin de s'inquiéter de l'expérience en matière de design ni de payer pour un designer haut de gamme. Tout ce dont tu as besoin pour créer une marque se trouve ici !
...
Crée un logo professionnel unique pour ton entreprise
Donnez un coup de pouce à ta marque avec des designs de cartes de visite, des graphismes pour les réseaux sociaux, des icônes d''applications, des en-têtes de lettre et plus encore


[More Information and Pricing](https://thataicollection.com/fr/application/logo-rank?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Découvrez le générateur de logos IA ultime : créez des logos personnalisés et spécifiques à un secteur en quelques minutes grâce à notre IA avancée. Aucune compétence en design n''est requise. Génère des logos pour la technologie, le commerce de détail, l''immobilier et plus encore gratuitement. Personnalise les couleurs, les polices et la mise en page, puis téléchargez-les aux formats PNG, JPG, PDF, SVG. Parfait pour les entreprises, l''image de marque personnelle et plus encore !


[More Information and Pricing](https://thataicollection.com/fr/application/ai-logo-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Vous avez du mal à « quoi cuisiner aujourd'hui » ? Notre générateur de nourriture IA t'aide à découvrir de délicieuses idées de recettes en fonction de tes ingrédients et de tes préférences. Résolvez instantanément ton dilemme en matière de planification des repas quotidiens, gratuitement et facilement !


[More Information and Pricing](https://thataicollection.com/fr/application/ai-food-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
- Propose des résumés et des transcriptions basés sur chatGPT, ce qui facilite la révision des réunions et
trouvez rapidement des informations importantes.
- Prend en charge plus de 100 langues
- Reconnaît différents locuteurs et langues lors d''une même réunion.
- Permet aux utilisateurs de partager facilement des enregistrements, facilitant ainsi la collaboration
- Convivial et facile à intégrer


[More Information and Pricing](https://thataicollection.com/fr/application/wudpecker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fireflies.ai aide ton équipe à enregistrer, transcrire, rechercher et analyser des conversations vocales. Enregistrez et transcrivez automatiquement les réunions, trouvez n''importe quoi grâce à la recherche basée sur l''IA, collaborez avec tes collègues, analysez les réunions grâce à l''intelligence conversationnelle



[More Information and Pricing](https://thataicollection.com/fr/application/fireflies?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 👨‍💻 Assistante de réunion Applications on AI Collection](https://thataicollection.com/fr/categories/meeting-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Transforme tes idées en applications Web fonctionnelles avec QuickIE.dev. Créez des applications Web à partir de commandes textuelles en quelques minutes, aucun codage n'est requis.


[More Information and Pricing](https://thataicollection.com/fr/application/quickie-dev?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
SubPage t'aide à créer des pages de destination, à créer des MVP et à développer rapidement ton audience. Aucune compétence en codage n'est requise. Capture des e-mails, valide des idées et renforce ta présence en ligne grâce à nos outils faciles à utiliser.


[More Information and Pricing](https://thataicollection.com/fr/application/subpage?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Passez de ton idée à une application partageable en quelques secondes. 
Demande simplement ce que tu veux et l'agent IA créera le site web pour toi. Tu peux également déployer tes applications et les partager avec le monde entier.



[More Information and Pricing](https://thataicollection.com/fr/application/srcbook?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fuselio est une agence de développement innovante conçue pour accélérer le développement de produits minimaux viables (MVP) pour les startups et les petites et moyennes entreprises (PME).


[More Information and Pricing](https://thataicollection.com/fr/application/fuselio?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fabric est un espace de travail alimenté par l'IA qui connecte ton contenu numérique sur les clouds, les applications et les appareils en un seul hub de recherche. Discutez avec des fichiers, organisez-vous automatiquement et trouvez tout ce que vous voulez en langage naturel. Collaborez facilement en temps réel tout en gardant tous tes fichiers, notes et liens organisés et accessibles. N'oublie plus jamais une idée et ne perds plus jamais un fichier.
...
Résumé PDF MyMap AI : ta solution intelligente pour condenser de longs documents en résumés concis et lisibles. Analyse et extrait rapidement les points clés de n'importe quel PDF en tirant parti de l'IA, ce qui te permet d'économiser du temps et des efforts. Idéal pour les étudiants, les professionnels et tous ceux qui souhaitent obtenir des informations essentielles en un coup d'œil. Essaye-le gratuitement dès maintenant et rationalise ton expérience de lecture !


[More Information and Pricing](https://thataicollection.com/fr/application/mymap-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Ideamap est une nouvelle méthode de brainstorming visuelle. Cela te permet de trouver rapidement des idées ou même de les classer automatiquement. Sur une toile visuelle infinie, tu peux réfléchir avec tes coéquipiers et un copilote IA ou en utilisant des modèles intégrés.
...
Whisper Memos transforme tes divagations en articles composés de paragraphes et te les envoie par e-mail.
Grâce à GPT-4, nous transformons ton mémo en article de journal, plutôt qu''en un mélange de mots.
...
[See All 📦 Autres Applications on AI Collection](https://thataicollection.com/fr/categories/other?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
SlideSpeak est un chatbot alimenté par ChatGPT qui vous permet de résumer des documents, de poser des questions et bien plus encore. Téléchargez simplement vos fichiers et vous pouvez utiliser le chat pour demander n''importe quoi. Notre IA est ultra rapide et vous n''avez pas besoin de connecter de clé API OpenAI.


[More Information and Pricing](https://thataicollection.com/fr/application/slidespeak?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/pdf-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
BARD PDF redéfinit la façon dont tu utilises les PDF. Il suffit de saisir l''adresse web d''un PDF et de laisser la technologie avancée de BARD PDF déchiffrer son contenu. Génère des résumés complets, cherche des réponses à tes questions dans le texte du PDF et participe à des discussions interactives sur le document lui-même. BARD PDF optimise ton temps et augmente ta productivité !


[More Information and Pricing](https://thataicollection.com/fr/application/bard-pdf?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Avec Podwise, tu peux apprendre grâce à des connaissances structurées et écouter de manière sélective les chapitres qui suscitent ton intérêt. Cette fonctionnalité te permet d''optimiser ton expérience d''apprentissage et de te concentrer sur le contenu qui compte le plus pour toi.


[More Information and Pricing](https://thataicollection.com/fr/application/podwise?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/helloscribe?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


[See All 🌱 Croissance personnelle et bien-être Applications on AI Collection](https://thataicollection.com/fr/categories/personal-growth-and-wellness?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Un nouveau coloriseur AI. Colorisez n''importe quoi à partir de vieilles photos en noir et blanc ð¸, stylisez vos œuvres d''art ð¨ ou donnez un nouveau look aux images modernes ð¶. C''est aussi simple qu''instagram


[More Information and Pricing](https://thataicollection.com/fr/application/palette?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🖼️ Restauration de photos Applications on AI Collection](https://thataicollection.com/fr/categories/photo-restoration?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Texti coopérera avec vous pour améliorer la qualité de votre contenu !


[More Information and Pricing](https://thataicollection.com/fr/application/texti?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Active la comparaison côte à côte entre le contenu de Wikipédia et celui de Grokipedia.

Améliore tes recherches grâce à des comparaisons instantanées côte à côte. L'extension Grokipedia VS Wikipedia est l'outil essentiel pour les lecteurs comparatifs, les chercheurs, etc.

Cette extension récupère automatiquement l'entrée Grokipedia correspondante et l'affiche côte à côte avec l'article de Wikipédia que tu es en train de lire.
...
AIPodNav : retranscription en direct du podcast AI
AIPodNav : une expérience de podcast ultime grâce à l'IA



[Visit](https://thataicollection.com/redirect/podnav?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Un outil de podcast efficace inclut une transcription, un résumé, une carte mentale, un chapitre, des points forts et des notes de présentation.
Le synthétiseur de podcasts et les services de transcription alimentés par l'IA fournissent une solution complète de gestion des informations sur les podcasts, afin de les rendre plus accessibles.
La transcription permet de rechercher des podcasts et d'identifier les locuteurs, tandis que les résumés offrent un aperçu rapide du contenu.
...
Drawing Prompt est un outil gratuit conçu pour les passionnés d''art basé sur l''IA. Il propose :
1. Expansion rapide : convertit des mots simples en instructions détaillées et créatives.
2. Exploration rapide et aléatoire : génère des invites aléatoires pour ceux qui recherchent des surprises et le plaisir de l''exploration, idéal lorsque tu ne sais pas quoi créer.
3. Création d''images : utilise le modèle SDXL pour transformer les instructions en œuvres d''art visuel époustouflantes.
...
Springworks développe des solutions logicielles de ressources humaines pour résoudre les problèmes de recrutement, de vérification des antécédents et d''engagement des employés avec Blockchain et l''IA
...
MoaiJobs est le site d'emploi #1 qui propose des offres d'emploi dans le domaine de l'IA. 

Nous t'offrons les meilleurs emplois dans des entreprises de pointe en matière d'IA. 

Tu peux filtrer les offres d'emploi par catégories, par nom d'entreprise et par lieu.

Tu peux également recevoir des alertes d'emploi par e-mail.


[More Information and Pricing](https://thataicollection.com/fr/application/moaijobs?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🧑‍💼 Recrutement et ATS Applications on AI Collection](https://thataicollection.com/fr/categories/recruiting-and-ats?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
MyMap.AI Research Paper Summarizer est un outil gratuit conçu pour rationaliser le processus de digestion des articles universitaires. Utilisant une IA de pointe, il synthétise avec précision des recherches complexes dans des résumés clairs et concis. Parfait pour les étudiants, les universitaires et les professionnels, cet outil améliore l'efficacité et permet de gagner du temps tout en garantissant une compréhension approfondie des principaux résultats et informations.


[More Information and Pricing](https://thataicollection.com/fr/application/mymap-ai-research-paper-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎓 Assistant de recherche Applications on AI Collection](https://thataicollection.com/fr/categories/research-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AIApply est une suite dynamique d''outils d''IA conçus pour donner plus de moyens aux demandeurs d''emploi. Il rationalise le processus de candidature, améliore la qualité des CV, prépare les entretiens et identifie les meilleures opportunités de carrière. AIApply personnalise les stratégies de recherche d''emploi afin de permettre aux utilisateurs de se démarquer sur les marchés concurrentiels. C''est un outil essentiel pour tous ceux qui souhaitent accélérer leur carrière grâce à la puissance de l''IA.


[More Information and Pricing](https://thataicollection.com/fr/application/aiapply?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Tu n''as pas besoin d''être une rédactrice de CV professionnelle pour créer rapidement et facilement un CV qui reflète fidèlement ton expérience professionnelle. Le générateur de CV IA personnalisable de Hunter t''aidera à rédiger un CV bien rédigé et adapté aux ATS afin de décrocher plus d''entretiens.


[More Information and Pricing](https://thataicollection.com/fr/application/huntr-ai-resume-builder?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
JobWinner est une plateforme alimentée par l'IA qui te permet d'obtenir plus d'entretiens et d'offres d'emploi. 
...
✔️ Job Match Insights : évalue dans quelle mesure tu es adaptée à chaque poste


[More Information and Pricing](https://thataicollection.com/fr/application/jobwinner?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 📋 Créateur de CV et de CV Applications on AI Collection](https://thataicollection.com/fr/categories/resume-and-cv-builder?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
SEOBy.ai t''aide à relancer tes efforts marketing et à être mieux classée sur les moteurs de recherche sans dépenser un centime. Générez du trafic organique vers ton site web/ta page de destination et vendez davantage de produits.
...
Présentation de SEOIfy : révolutionne le référencement de ton site Web grâce à notre plateforme de pointe alimentée par l''IA. Exploitez tout le potentiel de ton site grâce à une optimisation automatique en temps réel basée sur les normes du secteur. Améliore ton classement et ton trafic organique sans effort grâce à notre outil de référencement intelligent piloté par l''IA. 


[More Information and Pricing](https://thataicollection.com/fr/application/seoify?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

<br />


[See All 🔍 SEO et recherche de mots clés Applications on AI Collection](https://thataicollection.com/fr/categories/seo-and-keyword-research?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
ApplyPass est un outil de recherche d''emploi basé sur l''IA qui te permet d''obtenir plus d''entretiens d''embauche. ApplyPass soumet 200 à 400 candidatures personnalisées en ton nom chaque mois. Cet outil propose les 100 premières demandes d''emploi gratuitement.

ApplyPass.com a généré des milliers d''entretiens pour des ingénieurs, avec un taux de réponse moyen supérieur de 40 % à la moyenne du secteur.


[More Information and Pricing](https://thataicollection.com/fr/application/applypass?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LinkDr est un outil de création de liens basé sur l'IA conçu pour les équipes marketing qui souhaitent améliorer rapidement leur profil de backlinks. Nos algorithmes avancés et notre système de sensibilisation automatisé t'aident à identifier des opportunités de liens de haute qualité, à entrer en contact avec des partenaires influents et à obtenir des backlinks précieux 10 fois plus rapidement que les méthodes traditionnelles. 


[More Information and Pricing](https://thataicollection.com/fr/application/linkdr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Outil de recherche de prospects dans les boîtes aux lettres au niveau de l'entreprise, qui permet de rechercher des boîtes aux lettres professionnelles, d'exporter les résultats de la navigation commerciale sur LinkedIn, d'exporter les résultats de recherche, de prospection sur LinkedIn, de collecter des informations illimitées sur Apollo.io et d'autres fonctions. 
...
[See All 📞 Sensibilisation des ventes et génération de prospects Applications on AI Collection](https://thataicollection.com/fr/categories/sales-outreach-and-lead-gen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/frametrace-|-reverse-video-search?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

FrameTrace est un moteur de recherche vidéo inversé basé sur l'IA qui t'aide à trouver la source originale d'une vidéo, à détecter les doublons et à vérifier son authenticité sur des plateformes telles que YouTube, TikTok, Instagram et Reddit. Propulsé par des algorithmes avancés de vision par ordinateur et d'apprentissage automatique, il analyse les vidéos image par image pour retracer le contenu jusqu'à son origine et détecter les rediffusions non autorisées.


[More Information and Pricing](https://thataicollection.com/fr/application/frametrace-|-reverse-video-search?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Un assistant basé sur l''IA qui t''aide à être plus productif. Profitez du chat intelligent, sans effort
Il suffit de demander n''importe quoi à YouChat et d''obtenir des réponses utiles et immédiates.
Réponses complètes avec le GPT-4
Génère des réponses plus longues, plus détaillées et plus précises.



[More Information and Pricing](https://thataicollection.com/fr/application/you?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
PitchBob.io est un assistant numérique basé sur l'intelligence artificielle conçu pour aider les aspirants à devenir entrepreneurs. Cela aide non seulement à présenter, mais aussi à accomplir les tâches quotidiennes telles que la validation des idées, la création de P&L, ainsi que le réseautage. Par le biais d'un seul dialogue.
Adhérez au plan PRO pour 59,9$ au lieu de 79,9$ en utilisant ce code : THEAICLCTN


[More Information and Pricing](https://thataicollection.com/fr/application/pitchbob-io?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Storydoc est un éditeur de diapositives intuitif qui crée des présentations interactives. Cela permet de remplacer facilement les PDF statiques par des decks attrayants créés pour les équipes commerciales et marketing. Ils ont fait leurs preuves pour faire passer les prospects à l'étape suivante, t'aidant ainsi à décrocher plus de contrats. Chaque Storydoc regorge d'intégrations, permet de se connecter facilement à ton CRM et de personnaliser automatiquement tes decks pour chaque client.


[More Information and Pricing](https://thataicollection.com/fr/application/storydoc?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/podify.io?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
SynthLife est une plateforme conçue pour faciliter la création, la croissance et la monétisation d''influenceurs virtuels. Cet outil fournit une solution tout-en-un aux particuliers ou aux entreprises qui souhaitent se plonger dans le monde en pleine expansion des influenceurs virtuels, sans avoir besoin de compétences techniques avancées.


[More Information and Pricing](https://thataicollection.com/fr/application/synthlife?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
RIZZ AI est un outil de rencontres basé sur l'IA basé sur le framework RIZE GPT. Il possède une connaissance approfondie de la psychologie des utilisateurs et permet de proposer des conversations humoristiques et romantiques. Pour celles qui recherchent un assistant de prise en charge, RIZZ AI est le meilleur choix.
...
[See All 💞 Réseaux Sociaux & Rencontres Applications on AI Collection](https://thataicollection.com/fr/categories/social-networks-and-dating?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
HarmonySnippetsAI change la donne lorsqu'il s'agit de trouver les segments les plus captivants de tes morceaux de musique, surtout si tu essaies d'optimiser le contenu pour les réseaux sociaux.

Comment ça marche :

Uploade ton titre (MP3 ou WAV), et l'IA l'analysera pour sélectionner les segments les plus accrocheurs. Plus de conjectures.

S'il t'est déjà arrivé de ne pas savoir quelle partie de ton titre figurer, cet outil est fait pour toi. 


[More Information and Pricing](https://thataicollection.com/fr/application/harmonysnippetsai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Notre générateur d'effets sonores basé sur l'IA te permet de créer des effets sonores personnalisés pour tes projets. Qu'il s'agisse de sons futuristes ou de sons naturels, tu peux facilement générer un son unique pour améliorer ton contenu.


[More Information and Pricing](https://thataicollection.com/fr/application/ai-sound-effect-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Plongez dans l''univers des quiz interactifs avec QuizRise ! 🧠✨ 
Créez, personnalisez et partagez des quiz sans effort. 🌟 
Que tu partages des connaissances ou que tu perfectionnes tes compétences, QuizRise est là pour toi. 
Exporte les questionnaires aux formats PDF, TXT ou DOCX. 
Partez à la découverte avec nous ! 🚀📚


[More Information and Pricing](https://thataicollection.com/fr/application/quizrise?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎓 Étude et tutorat Applications on AI Collection](https://thataicollection.com/fr/categories/study-and-tutor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/todobee?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Une nouvelle façon d''enflammer l''imagination de votre enfant. Possibilités infinies de narration.


[More Information and Pricing](https://thataicollection.com/fr/application/kidotail?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Votre livre sera personnalisé avec des personnages, des images et une histoire. L''histoire et les illustrations ont également une fonction de synthèse vocale et peuvent être écoutées.
...
Utilisez Stable Diffusion pour générer des illustrations encadrées de haute qualité, sans soulever de pinceau. Tapez simplement à quoi vous voulez que votre peinture ressemble, générez votre art, choisissez votre cadre préféré et expédiez-le.


[More Information and Pricing](https://thataicollection.com/fr/application/ai-wall-decor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🖌️ Du texte à l'image Applications on AI Collection](https://thataicollection.com/fr/categories/text-to-image?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/ltx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

LTX est une plateforme de génération vidéo alimentée par l'IA, basée sur le modèle LTX 2.3, qui propose des outils de conversion de texte en vidéo, d'image en vidéo et de montage vidéo. Il permet aux utilisateurs de créer des vidéos époustouflantes de haute qualité en quelques secondes grâce à un traitement en temps réel, à un accès open source et à une sortie de qualité professionnelle, ce qui rend la création de vidéos IA simple et efficace pour tous les créateurs.


[More Information and Pricing](https://thataicollection.com/fr/application/ltx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Vidéos avec de faux textes
Vidéos Reddit
Préférerais-tu des vidéos
Vidéos AI Story
Vidéos fractionnées
Vidéos sous-titrées automatiquement

Et bien d'autres choses encore à venir !

Rejoignez-nous pour révolutionner l'espace de création de contenu dès maintenant.
...
Disponible dans plus de 100 langues et gratuitement.
...
Exploite des algorithmes avancés et l''IA pour convertir ton son en texte avec une précision absolue, mot pour mot, jusqu''à la dernière syllabe, expression idiomatique et nuance.

Langue maternelle dans plus de 100 langues.
Des transcriptions automatiques dans 100 langues et expressions idiomatiques différentes, multipliées par l''accent ou les particularités régionales que tu y ajoutes.


[More Information and Pricing](https://thataicollection.com/fr/application/riverside?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Découvrez une planification fluide des itinéraires de voyage grâce à notre plateforme pilotée par l''IA. Il propose de brèves escapades en ville ou des itinéraires prolongés d''une ou deux semaines, ainsi que des itinéraires artisanaux dans le monde entier. 
Demande et apprends tout ce que tu souhaites à notre assistant AI Travel sur les villes, les pays, les monuments et les activités. Enregistrer les réponses sous forme de notes de voyage et développer les itinéraires suggérés



[More Information and Pricing](https://thataicollection.com/fr/application/itinerarytrip?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🏖 Planificateur de vacances et de voyages Applications on AI Collection](https://thataicollection.com/fr/categories/vacation-and-trip-planner?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Notre start-up révolutionne la consommation de vidéos en proposant une extension de navigateur qui traduit et double le contenu vidéo dans la langue maternelle de l'utilisateur en temps réel. Conçu dans un souci d'efficacité et de facilité de compréhension, notre outil se concentre sur des vidéos éducatives et informatives afin d'améliorer l'apprentissage et la compréhension sans se laisser distraire par les sous-titres.
...
[See All 🎤 Doublage et traduction de vidéos Applications on AI Collection](https://thataicollection.com/fr/categories/video-dubbing-and-translation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/free-ai-kissing-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Transforme tes photos en vidéos de baisers magiques grâce à l'IA. Parfait pour les couples et les créateurs de contenu romantiques. Crée de magnifiques animations de baisers d'apparence naturelle en quelques secondes.


[More Information and Pricing](https://thataicollection.com/fr/application/free-ai-kissing-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Télécharge des vidéos et des courts métrages YouTube en HD avec le téléchargeur de vidéos YouTube AISEO. Aucune publicité, aucun filigrane ou aucune inscription requise. Rapide, gratuit et facile !


[More Information and Pricing](https://thataicollection.com/fr/application/youtube-video-downloader?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
- Édition par IA
L'IA extrait les meilleurs sujets de tes vidéos YouTube, des clips dignes d'un virus.
- Recadrage automatique
Recadre automatiquement tes clips vidéo pour toujours te concentrer sur le sujet le plus important.
- Des sous-titres attrayants
Interagissez avec tes abonnés grâce à des sous-titres magnifiquement conçus et à des sous-titres recommandés pour que le site devienne viral.
- Personnalisation
Tout personnaliser entièrement
- Publier et planifier



[More Information and Pricing](https://thataicollection.com/fr/application/klap-app?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Nagish sous-titre tes appels téléphoniques et te permet de parler par texto ou par la voix. C'est rapide, privé et gratuit. 
Nagish utilise l'intelligence artificielle (IA) pour convertir le texte en parole et la parole en texte en temps réel. Notre technologie permet de passer et de recevoir des appels facilement sans entendre ni parler. Au lieu de cela, tu peux taper et lire.


[More Information and Pricing](https://thataicollection.com/fr/application/nagish?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Télécharge maintenant le changeur de voix en temps réel gratuit pour PC. Modifie ta voix, choisis-en une dans l''univers vocal ou clone la voix de ton choix
...
[See All ☎️ Agent vocal et robot téléphonique Applications on AI Collection](https://thataicollection.com/fr/categories/voice-agent-and-phone-bot?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/aida?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Linkrr est un outil de gestion des liens polyvalent similaire à Linktree. Il propose des liens courts, des pages biographiques personnalisables, des codes QR, le partage de vcards, des transferts de fichiers et l'hébergement de sites HTML. Les fonctionnalités incluent les analyses, le raccourcissement des URL et les domaines personnalisés. Les plans tarifaires répondent à différents besoins et garantissent une gestion efficace de la présence en ligne.
...
[More Information and Pricing](https://thataicollection.com/fr/application/airops?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Webscrape AI est une plateforme avancée et conviviale qui permet aux particuliers et aux entreprises d''extraire des données du Web. C''est un scraper sans code qui ne nécessite aucune compétence en programmation, y compris des connaissances techniques limitées. Cet outil basé sur l''IA peut naviguer sur des sites Web, identifier les données pertinentes et les collecter dans un format structuré tel que CSV, JSON ou HTML. 
...
[See All ⚙️ Flux de travail et automatisation Applications on AI Collection](https://thataicollection.com/fr/categories/workflow-and-automation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/fr/application/wordfixerbot?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[Visit](https://thataicollection.com/redirect/ai-text-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Simplifie l'analyse du contenu grâce à notre synthétiseur de texte basé sur l'IA ! Il résume les choses rapidement, extrait les informations importantes, répond à tes questions et peut passer à plus de 80 langues.


[More Information and Pricing](https://thataicollection.com/fr/application/ai-text-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All ✍️ Assistante d''écriture Applications on AI Collection](https://thataicollection.com/fr/categories/writing-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
