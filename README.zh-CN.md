...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?label=%E7%94%9F%E6%88%90%E4%BA%BA%E5%B7%A5%E6%99%BA%E8%83%BD%E5%BA%94%E7%94%A8%E7%9A%84%E6%95%B0%E9%87%8F&message=3336&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>Gemma Guard — 使用设备端 Gemma 4 进行安卓网络钓鱼检测</h4>
    <p>Android 应用程序可在用户点按之前捕获屏幕、运行 OCR 并在本地使用 Gemma 4 来检测和解释网络钓鱼风险。

Gemma Guard 专为 Google Gemma 4 Good Hackathon 打造，是一款注重隐私的安卓应用程序，它展示了如何在真正的移动安全工作流程中使用 Gemma：捕捉有风险的屏幕、本地推理、解释结果并帮助用户安全行事。</p>
    <a href="https://thataicollection.com/redirect/gemma-guard" target="_blank"><b>开始使用 Gemma Guard</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>null</h4>
    <p>null</p>
    <a href="https://thataicollection.com/redirect/metatron" target="_blank"><b>开始使用 Metatron</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>由 LLM 驱动的发票和收据提取器 (OSS)</h4>
    <p>我们刚刚开源了一个基于语言模型的发票和收据提取器。它将凌乱的非结构化文本（来自OCR或扫描的文档）转换为简洁的结构化JSON，并附有字段级的置信度分数。

</p>
    <a href="https://thataicollection.com/redirect/llm-powered-invoice-and-receipt-extractor-oss" target="_blank"><b>开始使用 LLM-Powered Invoice & Receipt Extractor (OSS)</b></a>
    <br />
</div>
...
- 🦾 [人工智能代理](#人工智能代理)
- 🌄 [AI 艺术与插画](#ai-艺术与插画)
- 🕵️ [AI 探测器和人性化器](#ai-探测器和人性化器)
- 🎼 [AI 歌曲和音乐生成器](#ai-歌曲和音乐生成器)
- 🔮 [AI 塔罗牌与占卜](#ai-塔罗牌与占卜)
- 📈 [会计与金融](#会计与金融)
- 🪧 [广告创意生成器](#广告创意生成器)
- 🦾 [代理编码](#代理编码)
...
- 🇺🇳 [翻译和成绩单](#翻译和成绩单)
- 🏖 [假期和旅行计划](#假期和旅行计划)
- 🛠️ [Vibe 编码和应用程序生成器](#vibe-编码和应用程序生成器)
- 🎤 [视频配音和翻译](#视频配音和翻译)
- 🎬 [视频编辑](#视频编辑)
- ☎️ [语音代理和电话机器人](#语音代理和电话机器人)
- 🕸 [网页设计](#网页设计)
- ⚙️ [工作流程和自动化](#工作流程和自动化)
- ✍️ [写作助理](#写作助理)
## AI 合集的最新补充
...
#### GPT Image 2.5 — 具有更清晰细节和精确文本的 AI 图像生成器
...
基于 Web 的 AI 图像生成器，适用于高达 4K 的文本到图像和图像到图像，支持 16 张参考图像和更高的提示精度。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/gpt-image-2-5-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
FastSolve 是一款面向学生的 Chrome 扩展程序，可直接在 Canvas、Blackboard、Moodle 和 ALEKS 中提供人工智能答案和解释。双击问题可获得多项选择、填空、匹配或书面问题的帮助。免费套餐包括每天 10 道多选题，还有可选的付费计划。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/fastsolve?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 2.5 AI 2.5 AI | Seedance ·Seedance 2.5 AI


[Visit](https://thataicollection.com/redirect/시댄스-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

通过单个提示生成原生 30 秒 4K 视频，其中包含多达 50 个多模态引用和帧一致字符。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/시댄스-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### GPT Image 2.5 — 免费的人工智能图像生成器和编辑器
...
基于 Web 的图像生成器和编辑器，由 GPT Image 2.5 提供支持：多引用构图、精确编辑、可读文本和高达 4K 的导出。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/gpt-image-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI 电子邮件写作器 — 写作速度快 87%-已列入 AI Collection
...
人工智能电子邮件编写器，可将关键点转化为精美的电子邮件。永久免费套餐，无需注册；Chrome扩展程序和桌面应用程序。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/writemail-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 与 AI 导演一起将任何想法变成完成的视频。


[Visit](https://thataicollection.com/redirect/pixo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Pixo 是一个面向创作者和团队的代理驱动的 AI 视频平台。与 AI 导演聊天，该导演负责研究、编写脚本、故事板、使用领先的视频模型生成一致的场景、添加旁白以及在一个协作式浏览器工作区中编辑最终剪辑。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/pixo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### YouTube将使用人工智能进行转录—免费转换器和人工智能摘要
...
粘贴 YouTube 网址以获取带时间戳的笔录、人工智能摘要和 100 多种语言的翻译；导出 TXT/SRT/VTT/DOCX/CSV。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/youtube-to-transcript-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI 代理商店是企业寻找有效的 AI 代理的地方，开发人员可以展示他们的解决方案。浏览我们的经过验证的智能代理目录，查找符合您需求的智能代理，或列出您自己创建的智能代理以吸引新用户。
...
[See All 🦾 人工智能代理 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/ai-agents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Picture to Drawing 是一个先进的人工智能平台，可在几秒钟内将普通照片转换为令人惊叹的艺术图纸。我们尖端的人工智能技术会分析照片的每一个细节，以创建真实的图片到绘图的转换，从而保持原始图像的本质和情感。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/picture-to-drawing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AnimeGenius是一款免费增值的人工智能动画生成器，它使全球用户能够轻松创建令人惊叹的人工智能图像。它具有用户友好的界面以及各种可定制的模型和Lora，可满足初学者和有经验的艺术家的需求。该平台促进社区互动，允许用户分享创作并从彼此那里汲取灵感。
...
[See All 🕵️ AI 探测器和人性化器 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/ai-detector-and-humanizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
BeatViz AI：终极的一体化人工智能音乐和视频生成器。立即将您的想法变成完整曲目和专业级音乐视频。通过简单的文字提示创建高质量、同步的音乐和视觉效果，无需复杂的技能或昂贵的录音室设备。
...
RMIQ将您连接到顶级零售媒体网络上的优质广告空间，例如沃尔玛连接、Instacart、亚马逊、塔吉特等——无论客户在哪里购物，都能轻松地联系到他们。RMIQ 支持人工智能驱动的自动广告优化，以最大限度地提高 ROAS，并在不同的零售媒体网络上提供实时见解和报告。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/rmiq-ads?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/adobe-mic-check?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎧 音频增强器和人声去除 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/audio-enhancer-and-vocal-removal?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
根据你自己的照片训练 AI 模型，然后生成看起来像你或你所爱的人的逼真 AI 照片。

升级你的约会应用程序头像，看看你梦想中的身体会是什么样子，为LinkedIn或CV创建专业的个人资料照片，看看你和伴侣会生的孩子...可能性是无限的。
...
上传一张产品的照片，Mokker AI 就会神奇地以逼真的方式替换背景，不再有 photoshop 的外观。免费试用。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/mokker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 💻 编程助手 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/coding-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/detangleai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All ✉️ 电子邮件营销 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/email-marketing?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/pet-booth?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
ColorBliss 可以让你创建任何你能想象的彩页，完全是你想要的。

使用我们的文字提示功能，只需输入几句话来描述你的想法，在不到 5 秒钟的时间内，你就会得到一个独特的彩页。结合角色、设置和风格，让你的想象力变为现实！
...
[See All 🪪 头像生成器 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/headshot-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
释放人工智能的力量，获得问题的精确答案。非常适合学生、专业人士以及任何需要快速、可靠信息的人。

被艰巨的任务困住了吗？获取各个主题的分步解决方案。让家庭作业压力更小，更具教育意义。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/assignmentgpt-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
PicTools AI 提供了强大的 AI 工具，可以创建精美的图像、删除背景、模糊照片等。快速、简单，专为您的创造力而设计！
...
Interviews Chat 提供最先进的人工智能工具，可帮助你在求职面试中脱颖而出。借助我们的 AI 访谈 Copilot，您可以在 Zoom、Google Meet 或 Teams 等平台上获得实时转录和实时答案。使用 AI Interview Prep 更智能地准备求职面试——分析您的简历和职位描述，生成量身定制的练习问题。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/interviews-chat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Parakeet AI 通过提供针对特定行业和职位量身定制的实时 AI 生成的回复，帮助求职者在面试中脱颖而出。它与Zoom和Teams等流行的视频通话平台无缝集成，同时保持不可察觉的状态。该工具还通过加密通信确保隐私，并在会话结束后自动删除笔录。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/parakeet-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
创建可验证的证书，阻止欺诈行为，并确保您的内容归您所有。使用 ScoreDetect 体验诚信，这是你在数字空间中的盾牌。
...
厌倦了每天重复同样的食谱？试试我们的 AI 食谱生成器！输入食材，几秒钟内即可获得独特、美味的食谱。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-recipe-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/avoma?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🏷️ 名称、口号和命名生成器 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/name-slogan-and-naming-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fabric 是一个人工智能驱动的工作空间，可将您的数字内容跨云、应用程序和设备连接到一个可搜索的中心。与文件聊天，自动整理，并使用自然语言查找任何内容。实时无缝协作，同时保持所有文件、笔记和链接井井有条且易于访问。永远不要忘记一个想法或丢失文件。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/fabric?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 📦 其他 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/other?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🧑‍💼 招聘和 ATS Applications on AI Collection](https://thataicollection.com/zh-CN/categories/recruiting-and-ats?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/afforai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🎓 研究助理 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/research-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AIApply是一套动态的人工智能工具，旨在增强求职者的能力。它简化了求职流程，提高了简历质量，为面试做准备，并确定了最佳的职业机会。AIApply 个性化求职策略，确保用户在竞争激烈的市场中脱颖而出。对于任何希望借助人工智能的力量加快职业道路的人来说，它都是一个必不可少的工具。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/aiapply?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
您无需成为专业的简历撰写者即可快速轻松地创建准确反映您的工作经历的简历。Huntr可自定义的人工智能简历生成器将帮助您制作一份写得很好、适合ATS的简历，以帮助您获得更多面试。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/huntr-ai-resume-builder?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🔍 搜索引擎优化和关键字研究 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/seo-and-keyword-research?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
ApplyPass是一款由人工智能驱动的求职工具，可以让你获得更多的求职面试。ApplyPass每月代表你提交200-400份量身定制的求职申请。该工具免费提供前100份求职申请。

ApplyPass.com已经为工程师进行了数千次访谈，平均回复率比行业平均水平高40％。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/applypass?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LinkDR 是一款人工智能驱动的链接构建工具，专为想要快速增加反向链接配置的营销团队而设计。我们先进的算法和自动外联系统可帮助您识别高质量的链接机会，与有影响力的合作伙伴建立联系，并以比传统方法快 10 倍的速度保护有价值的反向链接。 
...
FrameTrace是一个由人工智能驱动的反向视频搜索引擎，它可以帮助你在YouTube、抖音、Instagram和Reddit等平台上找到任何视频的原始来源，检测重复内容并验证真实性。它由先进的计算机视觉和机器学习算法提供支持，逐帧分析视频，以追溯内容的来源，检测未经授权的转发。
...
HarmonySnippetSai是一款改变游戏规则的工具，它可以在音乐曲目中找到最迷人的片段，尤其是在你尝试优化社交媒体内容时。

它是如何工作的：

上传您的曲目（MP3 或 WAV），人工智能将对其进行分析以选出最吸引人的片段。不用再猜测了。

如果你一直不确定要展示曲目的哪一部分，这个工具就是为你准备的。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/harmonysnippetsai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All 🖌️ 文字转图片 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/text-to-image?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LTX 是一个基于 LTX 2.3 模型的人工智能视频生成平台，提供文本到视频、图像到视频和视频编辑工具。它使用户能够通过实时处理、开源可访问性和专业级输出在几秒钟内创建令人惊叹的高质量视频，使所有创作者都能轻松高效地创作 AI 视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ltx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/clippie-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
输入基于用户文本输入输出文本的应用程序的描述，我们将为您打造！
...
[See All 🎤 视频配音和翻译 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/video-dubbing-and-translation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用 AI 将您的照片转换为神奇的接吻视频。非常适合情侣和浪漫内容创作者。在几秒钟内创建漂亮、外观自然的接吻动画。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/free-ai-kissing-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用 AISEO YouTube 视频下载器以高清格式下载 YouTube 视频和短片。无需广告、水印或注册。快速、免费、简单！
...
-人工智能编辑
人工智能从你的YouTube视频中提取出最好的话题，使其具有病毒传播价值。
-自动重命名
自动重新构图您的视频片段，使其始终专注于最重要的主题。
-引人入胜的字幕
通过设计精美的字幕和推荐字幕吸引关注者，以帮助其传播开来。
-定制
完全自定义所有内容
-发布和安排
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/klap-app?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
SellerPic是一个专为电子商务卖家打造的AI SaaS平台，与Shopify、Facebook、抖音、Instagram和Canva无缝集成。卖家可以在SellerPic中直接导入产品图片，生成或编辑产品、模型和营销视觉效果，然后一键将其发布回商店或社交渠道。
...
VoAgents.ai 是一个先进的人工智能语音代理平台，旨在改变企业与客户的联系方式。我们的人工智能代理专为处理入站和出站呼叫而设计，可提供自然的、类似人类的对话，从而提高客户参与度并简化操作。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/voagents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Webscrape AI 是一个先进、用户友好的平台，允许个人和企业从网络中提取数据。它是一个无代码抓取工具，不需要编程技能，包括那些技术知识有限的人。这个人工智能驱动的工具可以浏览网站，识别相关数据，并以 CSV、JSON 或 HTML 等结构化格式进行收集。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/webscrapeai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All ⚙️ 工作流程和自动化 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/workflow-and-automation?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
WordFixerBot 的释义工具是帮助您快速准确地改写任何文本、句子、文章、段落、论文或文档的完美工具。立即开始，让你的写作脱颖而出！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/wordfixerbot?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用我们的 AI 文本摘要器简化内容分析！它可以快速总结，提取出重要的内容，回答你的问题，并可以切换到80多种语言。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-text-summarizer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[See All ✍️ 写作助理 Applications on AI Collection](https://thataicollection.com/zh-CN/categories/writing-assistant?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
